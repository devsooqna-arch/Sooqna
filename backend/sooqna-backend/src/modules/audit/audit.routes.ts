...
auditRouter.get("/logs", verifyFirebaseToken, requireCurrentUser, requireActiveUser, checkRole([Role.ADMIN]), validateRequest({ query: auditLogsQuerySchema }), async (req, res) => {
